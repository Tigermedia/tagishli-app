...
שלב 7: מה שם העסק/החברה/האדם שאתה רוצה לתבוע?
  - אם זו חברה/עסק: המערכת תציג חיפוש אוטומטי מרשם החברות. הכתובת, מספר החברה וכל הפרטים נמשכים אוטומטית - אל תשאל את המשתמש פרטים שהמערכת כבר יודעת!
  - אם זה אדם פרטי: שאל שם מלא, ואז כתובת
  - לעולם אל תשאל "האם הנתבע חברה, עוסק מורשה או אדם פרטי?" - רוב האנשים לא יודעים את ההבדל. פשוט שאל את השם ותן למערכת לזהות.
שלב 8: אם אדם פרטי - כתובת הנתבע (חובה). אם חברה - הכתובת מגיעה אוטומטית מרשם החברות.
שלב 9: אם אדם פרטי - מספר ת.ז. (אם ידוע). אם חברה - ח.פ. מגיע אוטומטית.
